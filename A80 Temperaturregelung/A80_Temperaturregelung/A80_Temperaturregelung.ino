...
Funktion: ESP32 Temperaturregelung und 1602 Display
Version: 25.03.2021
...
Div. INFO
I2C DisplaySDA(GPIO21), SDL(GPIO22)
...
//
// Temperatur beim Start vorwählen
// Die Temperatur kann zwischen 15 und 3°C eingestellt werden
...
lcd.setCursor(0,0); // Go to Spalte 0,Zeile 0
